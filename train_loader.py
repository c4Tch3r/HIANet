...
TRAIN_AUDIO_FOLDER = "<TRAIN_AUDIO_FOLDER>"
TRAIN_DATA_FOLDER = "<TRAIN_DATA_FOLDER>"
VAL_AUDIO_FOLDER = "<VAL_AUDIO_FOLDER>"
...
def loader(rgb=True, transform='cosine'):
    audio_target_length = ac.image_size ** 2 * ac.channels_audio * 3
    image_size = ac.image_size
    
    train_dataset = StegoDataset(
        image_root=TRAIN_DATA_FOLDER,
        audio_root=TRAIN_AUDIO_FOLDER,
        folder='train',
        rgb=rgb,
        transform=transform,
    ...
    val_dataset = StegoDataset(
        image_root=VAL_DATA_FOLDER,
        audio_root=VAL_AUDIO_FOLDER,
        folder='val',
        rgb=rgb,
        transform=transform,
        audio_target_length=audio_target_length,
