...
from AAIBlock import AAI_block


class AAINet(nn.Module):

    def __init__(self):
        super(AAINet, self).__init__()
        ...
        self.inv9 = AAI_block()
        self.inv10 = AAI_block()
        self.inv11 = AAI_block()
        self.inv12 = AAI_block()
        self.inv13 = AAI_block()
        self.inv14 = AAI_block()
        self.inv15 = AAI_block()
        self.inv16 = AAI_block()
